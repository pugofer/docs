...
@@@ hack need to swith id to class
#+begin_export html
<style>
...
- ~(:[])~ :: is the function which maps any value to the singleton list containing that element
...
- ~Name type1 ... typer~ where ~Name~ is a previously unused
  /constructor function name/
  (i.e. an identifier beginning with a capital letter).
  This declaration introduces ~Name~ as a new constructor function of
  type: ~type1 -> ...-> typer -> DatatypeName a1 ... an~.
- ~type1 CONOP type2~ where ~CONOP~ is a previously unused constructor
