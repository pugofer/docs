...
Command Description ------- ----------- <expr> Analyse expression for
errors, typecheck and evaluate. If
...
:t <expr> Analyse expression for errors, typecheck and print the :type
<expr> translation and inferred type of the term. :T

:q Exit Gofer interpreter. :quit :Q

:? Display summary of interpreter commands. :h :H
...
:load Equivalent forms of the :l command. :L
...
:also Equivalent forms of the :a command. :A
...
:reload Equivalent forms of the :r command. :R
...
:edit Equivalent forms of the :e command. :E
