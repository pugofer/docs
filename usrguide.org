...
#+SUBTITLE: HTML-ized by Rustom P. Mody — 2026\\
#+SUBTITLE: Minimal changes beyond formatting and markup\\
#+SUBTITLE: The forthcoming Pug Manual is a separate document, in preparation
...
- The null escape sequence "\&" is not generated in the printable
  ...
  practice.
- Unification of a type variable a with a type expression of the form T
  a where T is a synonym name whose expansion does not involve a will
  fail. It is not entirely clear whether this behaviour is correct or
  not.
...
- Type constructors in Gofer begin with capital letters (e.g. Bool, Char
  etc..) where lower case is used in [[[bib-1][1]]] (e.g. bool, char, etc..). Note
  that Gofer has no general numeric type "num" as used in [[[bib-1][1]]]; Use
